...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename round_key \
    op interface \
    ports { round_key_address0 { O 4 vector } round_key_ce0 { O 1 bit } round_key_q0 { I 8 vector } round_key_address1 { O 4 vector } round_key_ce1 { O 1 bit } round_key_q1 { I 8 vector } } \
} "
} else {
