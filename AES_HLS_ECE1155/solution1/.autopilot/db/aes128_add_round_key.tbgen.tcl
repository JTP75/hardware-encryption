set moduleName aes128_add_round_key
...
set C_modelName {aes128_add_round_key}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 2 2 } 1 1 }  }
	{ round_key int 8 regular {array 16 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "round_key", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ round_key_address0 sc_out sc_lv 4 signal 1 } 
	{ round_key_ce0 sc_out sc_logic 1 signal 1 } 
	{ round_key_q0 sc_in sc_lv 8 signal 1 } 
	{ round_key_address1 sc_out sc_lv 4 signal 1 } 
	{ round_key_ce1 sc_out sc_logic 1 signal 1 } 
	{ round_key_q1 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "round_key_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "round_key", "role": "q0" }} , 
 	...
 	{ "name": "round_key_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "round_key", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	round_key { ap_memory {  { round_key_address0 mem_address 1 4 }  { round_key_ce0 mem_ce 1 1 }  { round_key_q0 mem_dout 0 8 }  { round_key_address1 MemPortADDR2 1 4 }  { round_key_ce1 MemPortCE2 1 1 }  { round_key_q1 MemPortDOUT2 0 8 } } }
}
