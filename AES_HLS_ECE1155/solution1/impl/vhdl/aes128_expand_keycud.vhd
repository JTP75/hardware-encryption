...
entity aes128_expand_keycud_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes128_expand_keycud_rom is 
...
entity aes128_expand_keycud is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes128_expand_keycud is
    component aes128_expand_keycud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes128_expand_keycud_rom_U :  component aes128_expand_keycud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
