...
entity aes128_sub_bytes_cud_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes128_sub_bytes_cud_rom is 
...
entity aes128_sub_bytes_cud is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of aes128_sub_bytes_cud is
    component aes128_sub_bytes_cud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes128_sub_bytes_cud_rom_U :  component aes128_sub_bytes_cud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
