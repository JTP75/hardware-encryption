...
set DataType0 [list "ap_axis<8, 1, 1, 1>" "struct ap_axis" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "ap_axis<8, 1, 1, 1>" "struct ap_axis" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
