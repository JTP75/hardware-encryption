...
set C_modelArgList {
	{ expanded_key int 8 regular {array 176 { 1 3 } 1 1 }  }
	{ expanded_key_offset int 10 regular  }
	{ round_key int 8 regular {array 16 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	expanded_key { ap_memory {  { expanded_key_address0 mem_address 1 8 }  { expanded_key_ce0 mem_ce 1 1 }  { expanded_key_q0 mem_dout 0 8 } } }
	expanded_key_offset { ap_none {  { expanded_key_offset in_data 0 10 } } }
	round_key { ap_memory {  { round_key_address0 mem_address 1 4 }  { round_key_ce0 mem_ce 1 1 }  { round_key_we0 mem_we 1 1 }  { round_key_d0 mem_din 1 8 } } }
}
