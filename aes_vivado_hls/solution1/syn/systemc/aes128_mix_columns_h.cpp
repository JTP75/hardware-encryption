...
aes128_mix_columns_h::aes128_mix_columns_h(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    aes128_encrypt_blfYi_U26 = new aes128_encrypt_blfYi<1,1,8,8,8,8,2,8>("aes128_encrypt_blfYi_U26");
    aes128_encrypt_blfYi_U26->din0(column_0_2_reg_408);
    aes128_encrypt_blfYi_U26->din1(column_1_2_reg_414);
    aes128_encrypt_blfYi_U26->din2(column_2_2_reg_420);
    aes128_encrypt_blfYi_U26->din3(column_3_2_reg_426);
    aes128_encrypt_blfYi_U26->din4(tmp_10_fu_336_p1);
    aes128_encrypt_blfYi_U26->dout(tmp_4_fu_340_p6);
...
aes128_mix_columns_h::~aes128_mix_columns_h() {
    ...
    delete aes128_encrypt_blfYi_U26;
}
